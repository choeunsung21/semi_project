...
<body class="starter-page-page">
  ...
  <main class="main">
   ...
   <div class="container">
    ...
    <form action="<%=request.getContextPath() %>/MyPageUpdateServlet" method="post">
      ...
      <div class="form-group">
        ...
        <input type="email" id="userEmail" name="userEmail" value="${user.userEmail}" class="form-control" required>
      </div>
      
      <div class="form-group">
        <label for="userPhone">전화번호</label>
        <input type="text" id="userPhone" name="userPhone" value="${user.userPhone}" class="form-control" required>
      </div>
      
      <div class="form-group">
        <label for="userGender">성별</label>
        <select id="userGender" name="userGender" class="form-control" required>
          <option value="남성" ${user.userGender == '남성' ? 'selected' : ''}>남성</option>
          <option value="여성" ${user.userGender == '여성' ? 'selected' : ''}>여성</option>
        </select>
      </div>
